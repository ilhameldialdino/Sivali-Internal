...
const TableRow = ({ transactionId, date, name, amount, status}) => {
...
const ListTransaction = () => {
  const totalListTransactions = listTransaction.length;

  return (
    <Container className="px-0">
      <Row className="d-flex flex-wrap flex-md-nowrap align-items-center py-4">
        <Col className="d-block mb-4 mb-md-0">
          <h1 className="h2">List Transaction</h1>
          <p className="mb-0">
            Transaction of all credit.
          </p>
        </Col>
        ...
        <Card.Body className="pt-0">
          ...
          <Card.Footer className="px-3 border-0 d-lg-flex align-items-center justify-content-between">
            ...
            <small className="fw-bold">
              Showing <b>{totalListTransactions}</b> out of <b>25</b> entries
            </small>
          </Card.Footer>
        </Card.Body>
      </Card>
