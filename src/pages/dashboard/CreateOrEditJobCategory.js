  ...
  return (
    <Container className="px-0">
      <Row className="d-flex flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <h1 className="h2">{method} Industry </h1>
          <p className="mb-0">
            {method === "Create" ? "Creating new job category" : method === "Edit" ? "Editing job category" : ""}
          </p>
        </Col>
      </Row>  
...
export default CreateOrEditJobCategory;
